...
, ICloneable
#endif
    {
        ...
        /// <summary>
        /// The content names, positions, and orientations of mission Npcs on this map.
        /// </summary>
        private List<MapEntry<MissionNpc>> missionNpcEntries = 
            new List<MapEntry<MissionNpc>>();

        /// <summary>
        /// The content names, positions, and orientations of mission Npcs on this map.
        /// </summary>
        public List<MapEntry<MissionNpc>> MissionNpcEntries
        {
            get { return missionNpcEntries; }
            set { missionNpcEntries = value; }
        }
        ...
        public object Clone()
        {
            ...
            map.missionNpcEntries.AddRange(MissionNpcEntries);
        ...
        public class MapReader : ContentTypeReader<Map>
        {
            protected override Map Read(ContentReader input, Map existingInstance)
            {
                ...
                map.MissionNpcEntries.AddRange(
                    input.ReadObject<List<MapEntry<MissionNpc>>>());
                foreach (MapEntry<MissionNpc> missionNpcEntry in 
                    map.missionNpcEntries)
                {
                    missionNpcEntry.Content = input.ContentManager.Load<MissionNpc>(
                        System.IO.Path.Combine(@"Characters\MissionNpcs",
                        missionNpcEntry.ContentName));
                    missionNpcEntry.Content.MapPosition = missionNpcEntry.MapPosition;
                    missionNpcEntry.Content.Direction = missionNpcEntry.Direction;
                }
