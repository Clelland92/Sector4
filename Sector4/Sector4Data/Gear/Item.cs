...
{
    /// <summary>
    /// A usable piece of gear that has a rangedweapon-like effect.
    /// </summary>
    public class Item : Gear
    {
        ...
        public class ItemReader : ContentTypeReader<Item>
        {
            protected override Item Read(ContentReader input, Item existingInstance)
            {
                ...
                item.RangedWeaponSprite = input.ReadObject<AnimatingSprite>();
                item.RangedWeaponSprite.SourceOffset = new Vector2(
                    item.RangedWeaponSprite.FrameDimensions.X / 2,
                    item.RangedWeaponSprite.FrameDimensions.Y);
