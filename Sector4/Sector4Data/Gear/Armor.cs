    ...
    public class Armor : Equipment
    {
        ...
        public override string GetPowerText()
        {
            return "Weapon Defense: " + OwnerHealthDefenseRange.ToString() +
                "\nAmmo Defense: " + OwnerAmmoDefenseRange.ToString();
        }
        ...
        /// <summary>
        /// The range of ammo defense provided by this armor to its owner.
        /// </summary>
        private Int32Range ownerAmmoDefenseRange;

        /// <summary>
        /// The range of ammo defense provided by this armor to its owner.
        /// </summary>
        public Int32Range OwnerAmmoDefenseRange
        {
            get { return ownerAmmoDefenseRange; }
            set { ownerAmmoDefenseRange = value; }
        }
        ...
        public class ArmorReader : ContentTypeReader<Armor>
        {
            protected override Armor Read(ContentReader input, Armor existingInstance)
            {
                ...
                armor.OwnerAmmoDefenseRange = input.ReadObject<Int32Range>();
