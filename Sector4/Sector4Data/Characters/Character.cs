    ...
    public abstract class Character : WorldObject
    {
        ...
        private void AddStandardCharacterIdleAnimations()
        {
            if (mapSprite != null)
            {
                ...
                mapSprite.AddAnimation(new Animation("IdleSouthwest", 1, 1, 
                    MapIdleAnimationInterval, true));
                mapSprite.AddAnimation(new Animation("IdleWest", 1, 1, 
                    MapIdleAnimationInterval, true));
                mapSprite.AddAnimation(new Animation("IdleNorthwest", 1, 1, 
                    MapIdleAnimationInterval, true));
                mapSprite.AddAnimation(new Animation("IdleNorth", 1, 1, 
                    MapIdleAnimationInterval, true));
                mapSprite.AddAnimation(new Animation("IdleNortheast", 1, 1, 
                    MapIdleAnimationInterval, true));
                mapSprite.AddAnimation(new Animation("IdleEast", 1, 1, 
                    MapIdleAnimationInterval, true));
                mapSprite.AddAnimation(new Animation("IdleSoutheast", 1, 1, 
                    MapIdleAnimationInterval, true));
            }
        }
