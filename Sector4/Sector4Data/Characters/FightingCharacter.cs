...
namespace Sector4Data
{
    ...
    public abstract class FightingCharacter : Character
    {
        ...
        /// <summary>
        /// The cached list of rangedweapons for this level.
        /// </summary>
        private List<RangedWeapon> rangedweapons = null;
        ...
        public List<RangedWeapon> RangedWeapons
        {
            get 
            { 
                if ((rangedweapons == null) && (characterClass != null))
                {
                    rangedweapons = characterClass.GetAllRangedWeaponsForLevel(characterLevel);
                }
        ...
        /// <summary>
        /// The ammo defense range for this character, aggregated from all armor.
        /// </summary>
        private Int32Range ammoDefenseRange;

        /// <summary>
        /// The ammo defense range for this character, aggregated from all armor.
        /// </summary>
        public Int32Range AmmoDefenseRange
        {
            get { return ammoDefenseRange; }
        }
        ...
        public void RecalculateTotalDefenseRanges()
        {
            ...
            ammoDefenseRange = new Int32Range();
        ...
        private void AddStandardCharacterCombatAnimations()
        {
            if (combatSprite != null)
            {
                ...
                combatSprite.AddAnimation(new Animation("RangedWeaponShoot", 31, 36, 
                    CombatAnimationInterval, false));
