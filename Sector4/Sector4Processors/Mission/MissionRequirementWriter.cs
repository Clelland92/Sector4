...
namespace Sector4Processors
{
    ...
    /// </summary>
    [ContentTypeWriter]
    public class MissionRequirementWriter<T> : Sector4Writer<MissionRequirement<T>>
        where T : ContentObject
    {
        ...
        protected override void Write(ContentWriter output, MissionRequirement<T> value)
        {
