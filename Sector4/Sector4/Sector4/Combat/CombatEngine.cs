...
namespace Sector4
{
    ...
    class CombatEngine
    {
        ...
        /// <summary>
        /// The player of the combat engine.
        /// </summary>
        private static CombatEngine singleton = null;


        /// <summary>
        /// Check to see if there is a combat going on
        /// </summary>
        ...
        /// <summary>
        /// If true, the player is in combat.
        /// </summary>
        ...
        /// <summary>
        /// The fixed combat used to generate this fight
        /// </summary>
        ...
        private void BeginPlayersTurn()
        {
            ...
            Session.Hud.ActionText = "Your Turn";
        ...
        private void BeginMonstersTurn()
        {
            ...
            // set the action text on the HUD
            Session.Hud.ActionText = "Enemy Turn";
        ...
        /// <summary>
        /// Check for whether the monsters have been killed.
        /// </summary>
            ...
            StatisticsValue damage)
        {
            ...
            if (damage.AmmoPoints != 0)
            {
                CombatEffect combatEffect = new CombatEffect();
                combatEffect.OriginalPosition = position;
                combatEffect.Text = "Ammo\n" + damage.AmmoPoints.ToString();
                combatEffect.Rise = startingRise;
                startingRise -= 5;
                singleton.damageCombatEffects.Add(combatEffect);
            }
            ...
            if (damage.AmmoalOffense != 0)
            {
                CombatEffect combatEffect = new CombatEffect();
                combatEffect.OriginalPosition = position;
                combatEffect.Text = "MO\n" + damage.AmmoalOffense.ToString();
                combatEffect.Rise = startingRise;
                startingRise -= 5;
                singleton.damageCombatEffects.Add(combatEffect);
            }

            if (damage.AmmoalDefense != 0)
            {
                CombatEffect combatEffect = new CombatEffect();
                combatEffect.OriginalPosition = position;
                combatEffect.Text = "MD\n" + damage.AmmoalDefense.ToString();
                combatEffect.Rise = startingRise;
                startingRise -= 5;
                singleton.damageCombatEffects.Add(combatEffect);
            }
            ...
            StatisticsValue healing)
        {
            ...
            if (healing.AmmoPoints != 0)
            {
                CombatEffect combatEffect = new CombatEffect();
                combatEffect.OriginalPosition = position;
                combatEffect.Text = "Ammo\n" + healing.AmmoPoints.ToString();
                combatEffect.Rise = startingRise;
                startingRise -= 5;
                singleton.healingCombatEffects.Add(combatEffect);
            }
            ...
            if (healing.AmmoalOffense != 0)
            {
                CombatEffect combatEffect = new CombatEffect();
                combatEffect.OriginalPosition = position;
                combatEffect.Text = "MO\n" + healing.AmmoalOffense.ToString();
                combatEffect.Rise = startingRise;
                startingRise -= 5;
                singleton.healingCombatEffects.Add(combatEffect);
            }

            if (healing.AmmoalDefense != 0)
            {
                CombatEffect combatEffect = new CombatEffect();
                combatEffect.OriginalPosition = position;
                combatEffect.Text = "MD\n" + healing.AmmoalDefense.ToString();
                combatEffect.Rise = startingRise;
                startingRise -= 5;
                singleton.healingCombatEffects.Add(combatEffect);
            }
            ...
            switch (delayType)
            {
                ...
                case DelayType.FleeAttempt:
                    ...
                    else if (CalculateFleeAttempt())
                    {
                        ...
                        Session.Hud.ActionText = "You Have  Fled!";
                    }
                    else
                    {
                        delayType = DelayType.EndCharacterTurn;
                        Session.Hud.ActionText = "You Failed to Escape!";
                        if (highlightedCombatant != null)
                        {
                            highlightedCombatant.IsTurnTaken = true;
                        }
        ...
        /// <summary>
        /// Generates a list of CombatantPlayer objects 
        /// </summary>
        ...
        public static void AttemptFlee()
        {
            ...
            if (!IsPlayersTurn)
            {
                throw new InvalidOperationException("flee.");
            }
            ...
            switch (combatEndingState)
            {
                case CombatEndingState.Victory:
                    ...
                    foreach (CombatantMonster combatantMonster in monsters)
                    {
                        ...
                        moneyReward += monster.CalculateMoneyReward(Session.Random);
