...
{
    /// <summary>
    /// Displays the rewards earned by the party, from a mission or combat.
    /// </summary>
    class RewardsScreen : GameScreen
    {
        ...
        private Vector2 moneyAwardPosition;
        ...
        /// <summary>
        /// Creates a new RewardsScreen 
        /// </summary>
        public RewardsScreen(RewardScreenMode mode, int experienceReward,
            int moneyReward, List<Gear> gearReward)
            : base()
        {
            this.IsPopup = true;
            this.mode = mode;
            ...
            switch (mode)
            {
                ...
                case RewardScreenMode.Mission:
                    // play the mission-complete music
                    AudioManager.PushMusic("MissionComplete");
                    break;
            }
        ...
        public override void LoadContent()
        {
            ...
            selectIconPosition.X = screenSize.X / 2 + 560;
            ...
            moneyAwardPosition = backgroundPosition + new Vector2(160f, 210f);
        ...
        public override void HandleInput()
        {
                ...
                InputManager.IsActionTriggered(InputManager.Action.Back))
            {
                ...
                Session.Party.PartyMoney += moneyReward;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            titlePosition.Y = backgroundPosition.Y + 15f;
