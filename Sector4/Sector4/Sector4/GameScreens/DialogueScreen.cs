...
{
    /// <summary>
    /// Display of conversation dialog 
    /// </summary>
    class DialogueScreen : GameScreen
    {
        ...
        /// <summary>
        /// The dialogue shown in the main portion 
        /// </summary>
        ...
        /// <summary>
        /// The text shown next to the A button,
        /// </summary>
        ...
        /// <summary>
        /// The text shown next to the B button
        /// </summary>
        ...
        public override void LoadContent()
        {
            ...
            selectButtonTexture = content.Load<Texture2D>(@"Textures\Buttons\facebutton_a");
            backButtonTexture = content.Load<Texture2D>(@"Textures\Buttons\facebutton_b");
            ...
            selectButtonPosition.X = viewport.Width / 2 + 500;
            selectButtonPosition.Y = backgroundPosition.Y + 530f;
            selectPosition.X = selectButtonPosition.X -
                Fonts.ButtonNamesFont.MeasureString(selectText).X - 10f;
            selectPosition.Y = selectButtonPosition.Y;

            backPosition.X = viewport.Width / 2 - 530f;
