...
namespace Sector4
{
    ...
    class InventoryScreen : ListScreen<ContentEntry<Gear>>
    {
        ...
        /// <summary>
        /// If true, the menu is only displaying items
        /// </summary>
        ...
        public override ReadOnlyCollection<ContentEntry<Gear>> GetDataList()
        {
            ...
            //  a  list of only the desired gear
        ...
        /// <summary>
        /// Respond to the pressing of the Select action (and related key).
        /// </summary>
