...
namespace Sector4
{
    abstract class ListScreen<T> : GameScreen
    {
        ...
        protected Texture2D moneyTexture;
        private readonly Vector2 moneyTexturePosition = new Vector2(490f, 640f);
        protected string moneyText = String.Empty;
        private readonly Vector2 moneyTextPosition = new Vector2(565f, 648f);
        ...
        public override void LoadContent()
        {
            ...
            xButtonTexture =
                content.Load<Texture2D>(@"Textures\Buttons\facebutton_x");
            yButtonTexture =
        ...
        /// <summary>
        /// Respond to the pressing of the Back action.
        /// </summary>
        ...
        /// <summary>
        /// Respond to the pressing of the Select action.
        /// </summary>
        ...
        /// <summary>
        /// Draw the party money text.
        /// </summary>
        protected virtual void DrawPartyMoney()
        {
            if (!IsActive)
            {
                return;
        ...
        protected virtual void DrawButtons()
        {
            ...
            if ((backButtonTexture != null) && !String.IsNullOrEmpty(backButtonText))
            {
                ...
                spriteBatch.DrawString(Fonts.ButtonNamesFont, backButtonText,
                    backButtonTextPosition, Color.Black);
            }
