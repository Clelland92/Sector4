...
namespace Sector4
{
    ...
    class PlayerSelectionScreen : GameScreen
    {
        ...
        private Int32Range previewAmmoDefenseRange = new Int32Range();
        ...
        private readonly Vector2 selectButtonPosition = new Vector2(1091f, 550f);
        private readonly Vector2 backButtonPosition = new Vector2(131f, 550f);
        ...
        public override void  LoadContent()
        {
            ...
            selectButton = content.Load<Texture2D>(@"Textures\Buttons\facebutton_a");
            backButton = content.Load<Texture2D>(@"Textures\Buttons\facebutton_b");
            ...
            titlePosition = new Vector2(
                (viewport.Width - Fonts.HeaderFont.MeasureString("Equip Player").X) / 2,
                (viewport.Height - playerInfoScreen.Height) / 2 + 15f);
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(Fonts.HeaderFont, "Equip Player", titlePosition,
                Fonts.TitleColor);
        ...
        private void DrawPlayerDetails(Player player, bool isSelected)
        {
            ...
            previewAmmoDefenseRange = new Int32Range();
                ...
                if (usedGear is Equipment)
                {
                    ...
                    if (equipment is Weapon)
                    {
                        ...
                        if (equippedWeapon != null)
                        {
                            ...
                            previewAmmoDefenseRange -= 
                                equippedWeapon.OwnerBuffStatistics.AmmoalDefense;
                        }
                    }
                    else if (equipment is Armor)
                    {
                        ...
                        previewAmmoDefenseRange = armor.OwnerAmmoDefenseRange;
                    ...
                    previewAmmoDefenseRange +=
                        equipment.OwnerBuffStatistics.AmmoalDefense;
                }
            }
            ...
            Int32Range drawAmmoDefenseRange = player.AmmoDefenseRange + 
                previewAmmoDefenseRange + player.CharacterStatistics.AmmoalDefense;
            text = drawAmmoDefenseRange.Minimum.ToString();
            length = (int)Fonts.DescriptionFont.MeasureString(text).X;

            textColor = GetRangeColor(previewAmmoDefenseRange.Minimum, isSelected);
            spriteBatch.DrawString(Fonts.DescriptionFont, text,
                equipEffectPosition, textColor);
            equipEffectPosition.X += length;
            ...
            text = drawAmmoDefenseRange.Maximum.ToString();
            length = (int)Fonts.DescriptionFont.MeasureString(text).X;

            textColor = GetRangeColor(previewAmmoDefenseRange.Maximum, isSelected);
            spriteBatch.DrawString(Fonts.DescriptionFont, text,
                equipEffectPosition, textColor);
            equipEffectPosition.X += length;
            ...
            ref Vector2 position)
        {
            ...
            // Calculate HP and Ammo string Length
            ...
            detail2 = "Ammo: " + player.CurrentStatistics.AmmoPoints + "/" + 
            ...
            color = GetStatColor(playersStatisticsModifier.AmmoPoints, isSelected);
            spriteBatch.DrawString(Fonts.DescriptionFont, "Ammo: " +
                drawCurrentStatistics.AmmoPoints + "/" +
                drawCharacterStatistics.AmmoPoints,
                position, color);
