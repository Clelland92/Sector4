...
namespace Sector4
{
    ...
    class ControlsScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            rightStrings[1].text = "Page Right";
            ...
            backgroundTexture =
                content.Load<Texture2D>(@"Textures\MainMenu\Titlescreen");
            keyboardTexture =
